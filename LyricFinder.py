...
def main():
    ...
    browser.find_element(By.XPATH, '//input[@name="q"]').send_keys(
        input('Enter your song & artist name. (Ex. The Real Slim Shady Eminem): '))
    ...
    # Copies lyrics from first suggestion and prints to console.
